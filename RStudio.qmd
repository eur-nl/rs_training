...
Do you want to be more efficient when using RStudio? The following overview is based on the [RStudio User Guide](https://docs.posit.co/ide/user/ide/get-started/). It has been shortened to mostly show relevant content. \

## A quick tour through your IDE 

![Overview RStudio](./figures/RStudio/rstudio_labeled.png)
...
![How to create an empty script in RStudio](./figures/RStudio/R_file.png)

In this document, you can write all your code! Do not forget to save it in your working directory! 

![First look at the empty script in RStudio](./figures/RStudio/Empty_script.png)
...
![Syntax highlighting in RStudio](./figures/RStudio/rstudio_syntax_highlighting.png)
...
![Function completion in RStudio](./figures/RStudio/rstudio_completion.png)
...
![Documentation of sqrt() in RStudio](./figures/RStudio/rstudio_help.png)
...
![Breakpoints in RStudio](./figures/RStudio/rstudio_breakpoints.png)

Once your program reaches the breakpoint, it will stop and give you the insights that you wanted.

![debugger](./figures/RStudio/rstudio_debug.png)
...
![Code diagnostics in RStudio](./figures/RStudio/rstudio_diagnostics.png)
...
![Git in RStudio](./figures/RStudio/rstudio_git.png)
